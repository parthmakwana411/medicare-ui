                            ...
                            <div class="col-span-12" *ngFor="let item of items; let first = first">
                                <div class="flex flex-col sm:flex-row sm:items-center p-6 gap-4" 
                                    ...
                                    <div class="md:w-40 relative">
                                        <img style="width: 50%;" class="block xl:block mx-auto rounded-border" 
                                        ...
                                        <div class="flex flex-col md:items-end gap-8">
                                            <div class="flex justify-between md:flex-row-reverse gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p-button *ngIf="!item.quantity || item.quantity === 0"
                                                    ...
                                                    <p-inputnumber *ngIf="item.quantity && item.quantity > 0"
